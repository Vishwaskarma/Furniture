// app/gallery/[id]/GalleryDetailClient.jsx
// Client component: all interactivity (lightbox, zoom, keyboard nav) lives here.
// The route's page.jsx (server component) handles SEO metadata and passes
// down the projectId as a prop, since 'use client' files cannot export metadata.
'use client';
...
export default function GalleryDetailClient({ projectId }) {
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="fixed top-0 left-0 right-0 z-40 bg-black/95 backdrop-blur-xl border-b border-orange-500/30 p-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          {/* FIX: this was a second <h1> (duplicate H1s confuse Google about the
              page's main topic). The real H1 is the large heading below. */}
          <p className="text-xl font-bold text-orange-400 hidden sm:block">{project.title}</p>
