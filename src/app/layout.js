...
export const metadata = {
  ...
  // FIX: the old default title ("Carpenter | Carpenter Near Me | Furniture
  // Carpenter Mumbai | Best Carpenter Services | Vishwakarma Carpenter")
  // was ~105 characters — Google truncates titles at roughly 60 characters,
  // so it was being cut off mid-phrase in search results, and the
  // repetitive keyword-stacking pattern reads as spammy, which can hurt
  // click-through rate even when the page ranks. Shortened to a clear,
  // human-readable title that still leads with the main keyword.
  title: {
    default: "Best Carpenter in Mumbai | Vishwakarma Carpenter",
...
export default function RootLayout({ children }) {
  ...
  return (
    // FIX: was lang="hi" even though every word of on-page content is
    // English. A mismatched lang attribute is a language signal to Google
    // and can hurt how/whether the page ranks and displays for English
    // searches (e.g. "carpenter near me").
    <html lang="en" className="scroll-smooth">
      <head>
        <link rel="icon" href="/favicon.ico" sizes="any" />
        <link rel="apple-touch-icon" href="/apple-touch-icon.png" />
        <link rel="preload" href="/hero.jpg" as="image" />
        {/* FIX: removed the hreflang="en" alternate pointing at /en — that
            route doesn't exist in the app, so it was a broken hreflang tag.
            Add a real hreflang block back only once a genuine second-language
            version of the site exists. */}
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              // TODO: replace with your real Google Business Profile URL
              // (Google Business Profile → Share Profile) — this is what
              // helps Google connect this website to your GBP listing,
              // which is one of the biggest drivers of "call now" clicks
              // for local searches like "carpenter near me".
              sameAs: [
                "https://g.page/r/YOUR_GOOGLE_BUSINESS_PROFILE_ID",
                "https://www.facebook.com/vishwakarmacarpenter",
                "https://www.instagram.com/vishwakarmacarpenter"
              ]
            }),
